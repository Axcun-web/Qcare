...
/**
 * Weekly schedule editor for one doctor. Self-contained CRUD against
 * /admin/doctors/:id/jadwal and /admin/jadwal/:id; calls onChange() after
 * any successful mutation so the parent can refetch the owning clinic.
 */
export default function DoctorSchedule({ doctor, onChange, onError }) {
